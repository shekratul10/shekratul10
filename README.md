...
<p align="center"><strong>Software Engineer @ Lloyds Banking Group · Backend Engineering · AI Systems · Distributed Systems</strong></p>
...
**🚦 Distributed Rate Limiter** *(In Progress)* — `Go · Redis · Kubernetes · k6`

A distributed rate-limiting service designed to explore high-throughput backend engineering, concurrency, atomic operations, horizontal scaling, performance testing, and production observability.
